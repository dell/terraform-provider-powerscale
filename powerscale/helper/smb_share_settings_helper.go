...
>>>>>>> 99db475 (Implement smb default share settings resource)
=======
Copyright (c) 2024 Dell Inc., or its subsidiaries. All Rights Reserved.
...
func GetSmbShareSettings(ctx context.Context, client *client.Client, zone string) (*powerscale.V7SmbSettingsShare, error) {
