	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"zone": schema.StringAttribute{
				Description:         "The zone to which the user mapping applies. (Update Supported)",
				MarkdownDescription: "The zone to which the user mapping applies. (Update Supported)",
				Optional:            true,
			},
			"parameters": schema.SingleNestedAttribute{
				Description:         "Specifies the parameters for user mapping rules. (Update Supported)",
				MarkdownDescription: "Specifies the parameters for user mapping rules. (Update Supported)",
				Optional:            true,
				Computed:            true,
				Attributes: map[string]schema.Attribute{
					"default_unix_user": schema.SingleNestedAttribute{
						Description:         "Specifies the default UNIX user information that can be applied if the final credentials do not have valid UID and GID information. (Update Supported)",
						MarkdownDescription: "Specifies the default UNIX user information that can be applied if the final credentials do not have valid UID and GID information. (Update Supported)",
						Optional:            true,
						Computed:            true,
						Attributes: map[string]schema.Attribute{
							"domain": schema.StringAttribute{
								Description:         "Specifies the domain of the user that is being mapped. (Update Supported)",
								MarkdownDescription: "Specifies the domain of the user that is being mapped. (Update Supported)",
								Optional:            true,
								Computed:            true,
								Validators:          []validator.String{stringvalidator.LengthAtLeast(1)},
							},
							"user": schema.StringAttribute{
								Description:         "Specifies the name of the user that is being mapped. (Update Supported)",
								MarkdownDescription: "Specifies the name of the user that is being mapped. (Update Supported)",
								Required:            true,
								Validators:          []validator.String{stringvalidator.LengthAtLeast(1)},
							},
						},
			...
			"rules": schema.ListNestedAttribute{
				Description:         "Specifies the list of user mapping rules. (Update Supported)",
				MarkdownDescription: "Specifies the list of user mapping rules. (Update Supported)",
				Optional:            true,
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"operator": schema.StringAttribute{
							Description:         "Specifies the operator to make rules on specified users or groups. (Update Supported)",
							MarkdownDescription: "Specifies the operator to make rules on specified users or groups. (Update Supported)",
							Required:            true,
							Validators:          []validator.String{stringvalidator.OneOf("append", "insert", "replace", "trim", "union")},
						},
						"options": schema.SingleNestedAttribute{
							Description:         "Specifies the mapping options for this user mapping rule. (Update Supported)",
							MarkdownDescription: "Specifies the mapping options for this user mapping rule. (Update Supported)",
							Optional:            true,
							Computed:            true,
							Attributes: map[string]schema.Attribute{
								"break": schema.BoolAttribute{
									Description:         "If true, and the rule was applied successfully, stop processing further. (Update Supported)",
									MarkdownDescription: "If true, and the rule was applied successfully, stop processing further. (Update Supported)",
									Optional:            true,
									Computed:            true,
								},
								"user": schema.BoolAttribute{
									Description:         "If true, the primary UID and primary user SID should be copied to the existing credential. (Update Supported)",
									MarkdownDescription: "If true, the primary UID and primary user SID should be copied to the existing credential. (Update Supported)",
									Optional:            true,
									Computed:            true,
								},
								"group": schema.BoolAttribute{
									Description:         "If true, the primary GID and primary group SID should be copied to the existing credential. (Update Supported)",
									MarkdownDescription: "If true, the primary GID and primary group SID should be copied to the existing credential. (Update Supported)",
									Optional:            true,
									Computed:            true,
								},
								"groups": schema.BoolAttribute{
									Description:         "If true, all additional identifiers should be copied to the existing credential. (Update Supported)",
									MarkdownDescription: "If true, all additional identifiers should be copied to the existing credential. (Update Supported)",
									Optional:            true,
									Computed:            true,
								},
								"default_user": schema.SingleNestedAttribute{
									Description:         "Specifies the default user information that can be applied if the final credentials do not have valid UID and GID information. (Update Supported)",
									MarkdownDescription: "Specifies the default user information that can be applied if the final credentials do not have valid UID and GID information. (Update Supported)",
									Optional:            true,
									Computed:            true,
									Attributes: map[string]schema.Attribute{
										"domain": schema.StringAttribute{
						...
						"target_user": schema.SingleNestedAttribute{
							Description:         "Specifies the target user information that the rule can be applied to. (Update Supported)",
							MarkdownDescription: "Specifies the target user information that the rule can be applied to. (Update Supported)",
							Required:            true,
							Attributes: map[string]schema.Attribute{
								"domain": schema.StringAttribute{
									Description:         "Specifies the domain of the user that is being mapped. (Update Supported)",
						...
						"source_user": schema.SingleNestedAttribute{
							Description:         "Specifies the source user information that the rule can be applied from. (Update Supported)",
							MarkdownDescription: "Specifies the source user information that the rule can be applied from. (Update Supported)",
							Optional:            true,
							Attributes: map[string]schema.Attribute{
								"domain": schema.StringAttribute{
									Description:         "Specifies the domain of the user that is being mapped. (Update Supported)",
			...
			"test_mapping_users": schema.ListNestedAttribute{
				Description:         "List of user identity for mapping test. (Update Supported)",
				MarkdownDescription: "List of user identity for mapping test. (Update Supported)",
				Optional:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"name": schema.StringAttribute{
							Description:         "Specifies a user name. (Update Supported)",
							MarkdownDescription: "Specifies a user name. (Update Supported)",
							Optional:            true,
							Validators:          []validator.String{stringvalidator.LengthAtLeast(1)},
						},
