...
// LdapProviderDataSourceModel describes the data source data model.
type LdapProviderDataSourceModel struct {
	LdapProviders []LdapProviderDetailModel `tfsdk:"ldap_providers"`
	ID            types.String              `tfsdk:"id"`
	Filter        *LdapProviderFilterType   `tfsdk:"filter"`
}

// LdapProviderFilterType holds filter attribute for LDAP provider.
type LdapProviderFilterType struct {
...
// LdapProviderDetailModel describes the datasource data model.
type LdapProviderDetailModel struct {
