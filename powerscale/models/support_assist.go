...
type SupportAssistModel struct {
	...
	Access_key            types.String `tfsdk:"access_key"`
...
type V16SupportassistSettingsCustomised struct {
	...
	OnefsSoftwareId       *string                                       `json:"onefs_software_id,omitempty"`
...
type GatewayEndpoints struct {
	...
	Validate_ssl types.Bool   `tfsdk:"validate_ssl"`
	Priority     types.Int64  `tfsdk:"priority"`
	Use_proxy    types.Bool   `tfsdk:"use_proxy"`
