...
// can be customized.
//go:generate go run github.com/hashicorp/terraform-plugin-docs/cmd/tfplugindocs@v0.25.0 generate --provider-name powerscale
...
func main() {
	...
	opts := providerserver.ServeOpts{
		Address: "registry.terraform.io/dell/powerscale",
		Debug:   debug,
	}
