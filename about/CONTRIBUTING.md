...
* Contribute to the Terraform provider for Dell PowerScale documentation and codebase.
...
All issues related to Terraform provider for Dell PowerScale, regardless of the service/repository the issue belongs to (see table above), should be submitted [here](https://github.com/dell/dell-terraform-providers/issues). Issues will be triaged and labels will be used to indicate the type of issue. This section outlines the types of issues that can be submitted.  

### Report bugs

We aim to track and document everything related to Terraform provider for Dell PowerScale via the Issues page. The code and documentation are released with no warranties or SLAs and are intended to be supported through a community driven process.
...
We'd love your help answering questions being asked by other Terraform provider for Dell PowerScale users.
...
If you don't have the knowledge or time to code, consider helping with _issue triage_. The Terraform provider for Dell PowerScale community will thank you for saving them time by spending some of yours.
...
Terraform provider for Dell PowerScale uses the guidelines for commit messages outlined in [How to Write a Git Commit Message](https://chris.beams.io/posts/git-commit/)
