...
resource "powerscale_filepool_policy" "example_filepool_policy" {
  ...
  # A unique name for this policy. (Update Supported)
...
- `name` (String) A unique name for this File Pool Policy. (Update Supported)
...
# The command is
# terraform import powerscale_filepool_policy.example_filepool_policy <policyName>
# Example:
terraform import powerscale_filepool_policy.example_filepool_policy policyName
