...
# PowerScale Writable Snapshots allows you to get a list of Writable Snapshots or a Writable Snapshot by its Path which is given in ID.
...
data "powerscale_writable_snapshot" "writable" {
  id = "/ifs/path/to/writable/snapshot"
}
